...
export default function EditProfilePage() {
  ...
  useEffect(() => {
    if (appUser) {
      form.reset({
        ...
        photoFileId: appUser.photoFileId || null,
  ...
  const handleImageUploadSuccess = (
    ...
    form.setValue("photoURL", newImageUrl);
    form.setValue("photoFileId", newImageFileId);
  };
  ...
  const onSubmit: SubmitHandler<ProfileFormData> = async (data) => {
    ...
    if (data.photoFileId !== undefined && data.photoFileId !== null) formData.append("photoFileId", data.photoFileId); else formData.append("photoFileId", "");
